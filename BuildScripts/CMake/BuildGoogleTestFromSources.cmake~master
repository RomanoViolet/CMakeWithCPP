...
include (${CMAKE_CURRENT_SOURCE_DIR}/BuildGoogleTestFromSources.cmake)
function(BuildGoogleTestFromSources)
 message("Build Google Tests start...")
include(ExternalProject)
message("Included External project...")
...
ExternalProject_Add(
  ...
  message("Added External project...")
  ...
  message("Created Empty Directories...")
...
endfunction(BuildGoogleTestFromSources)
