...
function(buildDemoLibrary)
  ...
  include_directories(
    ...
    ${PROJECT_SOURCE_DIR}/CoreFunctions/Interfaces # Interfaces required for
                                                   # components
    ${FANCYSQUAREROOT_HEADER_DIR} # Headers related to the FancySquareRoot
                                  # dependency
  )

  # include c files so that the linker can find the implementations Legacy
  # sources do not come with their CMakeLists.txt, so "add_subdirectory" is not
  # an option
  ...
  file(GLOB_RECURSE DEMOLIBRARY_SOURCES
       ${PROJECT_SOURCE_DIR}/CoreFunctions*.cpp)
  ...
  # Link various  parts
  target_link_libraries(DemoLibrary PUBLIC FancySquareRoot)
