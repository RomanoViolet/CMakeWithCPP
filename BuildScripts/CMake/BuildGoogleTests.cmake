...
function(BuildGoogleTests)
  ...
  set (GOOGLETESTINSTALLDIRECTORY
      ${GoogleTestInstallDirectory}
      CACHE FORCE "GOOGLETESTINSTALLDIRECTORY"
      )



  add_dependencies(${GMOCK_MAIN_LIBRARY} ${GTEST_LIBRARY})
  add_dependencies(Interfaces googletest)
  add_custom_target(AllGoogleTests ALL DEPENDS ${UNIT_TEST_TARGETS})
  add_custom_target(InterfaceTarget ALL DEPENDS Interfaces)
