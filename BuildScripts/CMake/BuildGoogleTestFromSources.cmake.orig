...
function(BuildGoogleTestFromSources)
    ...
    ExternalProject_Add(
      ...
      set(GTEST_INCLUDE_DIRS ${source_dir}/googletest/include CACHE FORCE "GTEST_INCLUDE_DIRS")
      set(GMOCK_INCLUDE_DIRS ${source_dir}/googlemock/include CACHE FORCE "GMOCK_INCLUDE_DIRS")
